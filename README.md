...
שנמצאת לכל היותר במרחק הנתון מנקודת המקור
...
נקודות הפגיעה לא יודפס, ושם הדמות יופיע בסוגריים. לפני השם תופיע אות שמציינת את סוג הדמות: N לנינג'ה וC
לבוקר.

עבור בוקרים מוגדר גם הפרמטר "כמות כדורים" (מספר שלם) בוקר תמיד נוצר עם שישה כדורים ו110 נקודות פגיעה.
